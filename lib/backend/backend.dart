...
import 'schema/listeners_record.dart';
...
export 'schema/listeners_record.dart';
...
Future<FFFirestorePage<LeadersRecord>> queryLeadersRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
/// Functions to query ListenersRecords (as a Stream and as a Future).
Future<int> queryListenersRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ListenersRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ListenersRecord>> queryListenersRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<ListenersRecord>> queryListenersRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<ListenersRecord>> queryListenersRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
