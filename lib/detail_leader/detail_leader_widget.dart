...
import 'detail_leader_model.dart';
export 'detail_leader_model.dart';

class DetailLeaderWidget extends StatefulWidget {
  const DetailLeaderWidget({
    Key? key,
    this.ref,
  }) : super(key: key);
  ...
  @override
  _DetailLeaderWidgetState createState() => _DetailLeaderWidgetState();
}

class _DetailLeaderWidgetState extends State<DetailLeaderWidget> {
  late DetailLeaderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailLeaderModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final detailLeaderUsersRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                    ...
                    child: StreamBuilder<List<CalendarRecord>>(
                      stream: queryCalendarRecord(
                        queryBuilder: (calendarRecord) => calendarRecord
                            .where('leader', isEqualTo: widget.ref),
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
